...
import com.quailcash.android.data.model.BankAccount
import com.quailcash.android.data.model.BankGroup
import com.quailcash.android.data.model.CategoryTotalsMonth
import com.quailcash.android.data.model.DayLimit
...
import com.quailcash.android.ui.theme.QuailText
...
fun HomeScreen(
    ...
    Scaffold(
        ...
        when (selectedTab) {
            ...
            CashTab.ALL -> {
                val allViewModel: com.quailcash.android.ui.screens.home.AllTransactionsViewModel = viewModel(
