...
def account_transactions_range(
    ...
    with with_db_cursor() as (conn, cur):
        ...
        # Peer detection: you already have this helper in app_postgresOld.py.
...
def bank_info():
    with with_db_cursor() as (conn, cur):
        ...
        # Your app_postgresOld.py already defines latest_rates_map_pg()
...
# -----------------------------------------------------------------------------
# /month-budget
# NOTE: assumes recurring_calendar(...) exists in your app_postgresOld.py (same as sqlite version)
# -----------------------------------------------------------------------------
...
def page_account(
    ...
    """
    payload: Dict[str, Any] = {
        "account": account_info(account_id=account_id),                        # existing route fn【turn10file2†app_postgresOld.py†L1-L12】
        "transactions": account_transactions(account_id=account_id, limit=tx_limit),  # existing route fn【turn10file0†app_postgresOld.py†L54-L99】
...
def page_all_transactions(
    ...
    """
    # transactions_all() exists right after transactions() in your file【turn10file0†app_postgresOld.py†L100-L103】
    payload: Dict[str, Any] = {
...
def page_category(
    ...
    """
    # These function names are placeholders — wire to whatever your app_postgresOld.py already has.
    # Example:
    #   category_trend(c=...)
